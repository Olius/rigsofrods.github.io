...
set :asciidoc_attributes, %w(header_footer=true, source-highlighter=coderay)
...
activate :deploy do |deploy|
  deploy.method = :git
  # Optional Settings
  deploy.remote   = 'git@github.com:skybon/skybon.github.io.git' # remote name or git url, default: origin
